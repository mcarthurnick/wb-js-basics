...
let users = [{name: "Nick", age: 39}, {name: "Nicole", age: 44}, {name: "Reed", age: 65}, {name: "Susie", age: 60}];
...
let family = {
  ...
  reed : {
    hobbies: ['golfing', 'napping'],
  },
  mitch : {
    hobbies: ['motocross', 'racing']
  }
};
...
let gameScores = [[78, 89], [45,89], [99,45]]
